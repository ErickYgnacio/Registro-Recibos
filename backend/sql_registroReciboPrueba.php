<?php
    ...
    if(sqlsrv_has_rows($queryRecibo)){
        echo ('<script type="text/javascript">window.location.href = "../indexPrueba.php?mensaje=Ya Existe el Recibo Digitado-Prueba&codContribuyente='.$_POST['codContribuyente'].'&nombres='.$_POST['nombres'].'&fecha='.$_POST['fecha'].'&monto='.$_POST['monto'].'"</script>');
    }
    ...
    if(sqlsrv_query($conn,$queryInsert)){
        ...
        echo('<script type="text/javascript">window.location.href = "../indexPrueba.php?mensaje=Registro Correcto IndexPrueba"</script>');
