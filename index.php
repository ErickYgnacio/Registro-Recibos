    ...
    <div class="container pt-2">
        <main>
            <div class="py-3 text-center">
                <img class="d-block mx-auto mb-4" src="img/favicon.png" alt="" width="130" height="170">
                <h2>REGISTRO ENTRY SIGET</h2>
                <p class="lead">Pagina de ayuda para el Sistema SIGET. Cualquier error o inconveniente comunicarse con el area de Informatica para una solucion</p>
            </div>
            <hr class="my-4">
            <div class="row g-5">
                <div class="col-md-12 col-lg-12">
                    <h4 class="mb-3">Formulario de Registro</h4>
                    <form class="needs-validation" novalidate action="backend/sql_registroRecibo.php" method="POST">
                        ...
                        <div class="row gy-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select" id="activo" name="activo" required>
                                    ...
                                    <option value="0">Extornado</option>
                                </select>
                                <div class="invalid-feedback">
